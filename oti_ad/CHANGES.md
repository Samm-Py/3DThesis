...
> **Historical record.** This describes the first prototype (commit `5697d70`
> on this branch), which differentiated with respect to x, y, z, beam power,
> and the material properties k, rho and c_p. The current solver seeds
> per-row process controls instead: x, y, z, Q, sigma, v and tau. The scripts
> in this directory expect the prototype's output columns and do not run
> against the current build. For how the code works today, start with
> [`../ad_tutorial/README.md`](../ad_tutorial/README.md).
