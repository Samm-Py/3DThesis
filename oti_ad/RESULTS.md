...
> **Historical record.** These results are for the first prototype (commit
> `5697d70` on this branch), with directions x, y, z, Q, k, rho, c_p. The
> current solver's directions and checks are described in
