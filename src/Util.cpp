...
void Util::AddToNodes(Nodes& nodes, const int_seg seg) {
	...
	nodes.phix.push_back(1.0/seg.phix);	// Precompute division
	nodes.phiy.push_back(1.0/seg.phiy);	// Precompute division
	nodes.phiz.push_back(1.0/seg.phiz);	// Precompute division
