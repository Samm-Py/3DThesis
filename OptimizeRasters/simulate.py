...
# Directory holding this module (OptimizeRasters), used to resolve the binary
# and case directory independently of the caller's working directory.
...
THESIS_BIN = os.path.abspath(os.environ.get(
    "THESIS_BIN", os.path.join(_HERE, "..", "build", "bin", "3DThesis")))
CASE_DIR = os.path.abspath(os.environ.get(
    "THESIS_CASE", os.path.join(_HERE, "3DThesis", "TestInputs")))
