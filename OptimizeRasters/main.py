...
# Load up desired scan path to change
scanPath = Scan.LoadScan(inFile = "ScanPaths/51/scanpath.txt")
    ...
    if (lastVals[0]=='0' and lastVals[4]=='1'):
        ...
        while (iter < iterDepth):
            ...
            while (True):
                ...
                speed = 0.7 #optimal_speed + (j * d) * speedRes / (2 ** iter)
...
# Output the scan path to be simulated
Scan.ExportScan(scanPath_optimized, outFile="ScanPaths/51/scanpath_optimized.txt")